    ...
    <main className="min-h-screen py-24">
      <div className="container-custom">
        ...
        <div className="flex justify-between items-end mb-16">
          <div>
            <span className="text-[10px] uppercase tracking-[0.3em] text-brand-teal mb-4 block font-bold">
              TODOS OS PROJECTOS
            </span>
            <h1 className="text-5xl md:text-7xl font-bold">
              Portfolio <span className="text-white/30 italic font-medium">Completo</span>
            </h1>
          </div>
          <button
            onClick={() => navigate(-1)}
            className="hidden sm:flex items-center gap-2 text-sm text-white/40 hover:text-white transition-colors uppercase tracking-widest font-bold"
          >
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-8 pt-4 text-xs font-bold uppercase tracking-widest">
                  <a href={project.link} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-brand-teal transition-colors">
                    Ver Projeto <ArrowRight className="w-4 h-4" />
                  </a>
                  <a href={project.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/40 hover:text-white transition-colors">
                    GitHub <GithubIcon />
                  </a>
                </div>
              </motion.div>
